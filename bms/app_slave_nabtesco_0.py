...
def get_bms_actual_set_rpm():
    ...
    #- Nabtesco Settings
    o2.insert(tk.INSERT,int(bms_set_actual_rpm[0]))
    o3.insert(tk.INSERT,int(bms_set_actual_rpm[1]))
    
    # [Test Code]
    # bin =  util.bindigits2(bms_set_actual_rpm[0],16)
    # print("complementary bits:", bin)
    # print("to int:", int(bms_set_actual_rpm[0],2))
...
def resp_nas_rpm_cmd():
    ...
    # Nabtesco Settings:
    rpm_set = gui_input
    server.data_bank.set_input_registers(0,[rpm_set])
    print("RPM Set:", rpm_set)
